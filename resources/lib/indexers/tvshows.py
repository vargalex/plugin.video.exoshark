...
class tvshows:
    def __init__(self):
        ...
        self.toprated_link = 'http://api.trakt.tv/users/justin/lists/imdb-top-rated-tv-shows/items'
    ...
    def tvshowDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                cm.append((playRandom, 'RunPlugin(%s?action=random&rtype=season&tvshowtitle=%s&year=%s&imdb=%s&tvdb=%s)' % (sysaddon, systitle, year, imdb, tvdb)))
