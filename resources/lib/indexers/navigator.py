...
class navigator:
    def root(self):
        if es_utils.checkrepo():
            self.addDirectoryItem(u'EXOSHARK - NEM HIVATALOS VERZI\u00D3', 'dialogrepo', '', 'DefaultMovies.png')
        ...
        # self.addDirectoryItem(32007, 'channels', 'channels.png', 'DefaultMovies.png') # javitasra szorul
    ...
    def furk(self):
        self.addDirectoryItem(u'Saj\u00E1t f\u00E1jlok', 'furkUserFiles', 'mytvnavigator.png', 'mytvnavigator.png')
        self.addDirectoryItem(u'Keres\u00E9s', 'furkSearch', 'search.png', 'search.png')
        self.endDirectory()
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem(u'Legjobbra \xe9rt\xe9kelt', 'movies&url=toprated', 'most-voted.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem(u'\u00DAj lemezes megjelen\u00E9sek', 'movies&url=latestreleases', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(32005, 'movieWidget', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem(u'Legjobbra \xe9rt\xe9kelt', 'tvshows&url=toprated', 'most-voted.png', 'DefaultTVShows.png')
        ...
        if lite == False:
            ...
            self.addDirectoryItem(32028, 'tvPerson', 'people-search.png', 'DefaultTVShows.png', isFolder=False)
    ...
    def tools(self):
        ...
        self.addDirectoryItem(u'[B]EXOSHARK[/B] : V\u00E1ltoz\u00E1slista', 'changelogtxt', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(u'[B]EXOSHARK[/B] : Fejleszt\u0151i eszk\u00F6z\u00F6k', 'devTools', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def dev_tools(self):
        self.addDirectoryItem(u'Kiszolg\u00E1l\u00F3k friss\u00EDt\u00E9se', 'refreshProviders', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(u'Kiszolg\u00E1l\u00F3k ellen\u0151rz\u00E9se', 'checkProviders', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(u'Kiszolg\u00E1l\u00F3 tesztel\u00E9s be- vagy kikapcsol\u00E1sa', 'providerTest', 'tools.png', 'DefaultAddonProgram.png')
