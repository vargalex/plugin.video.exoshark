...
class source:
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            result = client.parseDOM(r, 'tr', attrs={'name': 'hover'})
            result = [(client.parseDOM(i, 'a', attrs={'class': 'magnet'}, ret='href')[0], client.parseDOM(i, 'a', attrs={'class': 'epinfo'}, ret='title')[0], i) for i in result]
