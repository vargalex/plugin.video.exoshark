...
class source:
    def __init__(self):
        self.priority = 0
        self.language = ['en']
        self.domains = ['http://torsproject.com']
        self.base_link = 'http://torsproject.com'
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            result = client.parseDOM(r, 'table', attrs={'class': 'rtable'})[0]
            result = client.parseDOM(result, 'tr')
            result = [(client.parseDOM(i, 'a', attrs={'title': 'Download Torrent Magnet'}, ret='href')[0], client.parseDOM(i, 'a')[0], i) for i in result[1:]]
