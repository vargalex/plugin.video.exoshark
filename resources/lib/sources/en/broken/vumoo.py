...
from resources.lib.modules import cfscrape, client, cleantitle, source_utils, directstream
...
class source:
    def __init__(self):
        ...
        self.search_path = '/search?t=13579&q=%s'
        self.password = 'iso10126'
        self.scraper = cfscrape.create_scraper()
        self.useragent = 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.117 Safari/537.36'
