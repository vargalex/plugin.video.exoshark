...
class source:
    def __init__(self):
        self.priority = 0
        self.language = ['en']
        self.domains = ['torrentz2.eu', 'torrentz2.is', 'torrentz2.cc']
        self.base_link = 'https://torrentz2.eu'
        self.search_link = '/feed?f=%s'
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            result = [(client.parseDOM(i, 'title')[0], client.parseDOM(i, 'link')[0], client.parseDOM(i, 'description')[0]) for i in result]
