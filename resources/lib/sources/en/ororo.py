...
import re, urlparse, json, base64, traceback
...
class source:
    def __init__(self):
        ...
        self.api_base_link = 'https://front.ororo-mirror.tv'
    ...
    def episode(self, url, imdb, tvdb, title, premiered, season, episode):
        try:
            ...
            url = urlparse.urljoin(self.api_base_link, url)
    ...
    def ororo_moviecache(self, user):
        try:
            url = urlparse.urljoin(self.api_base_link, self.moviesearch_link)
    ...
    def ororo_tvcache(self, user):
        try:
            url = urlparse.urljoin(self.api_base_link, self.tvsearch_link)
