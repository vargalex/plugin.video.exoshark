...
def cache_version_check():
    ...
    if _find_cache_version():
        cache_clear(); cache_clear_meta(); cache_clear_providers(); repo_version_check()
        control.infoDialog(u'Az ExoShark \u00FAj verzi\u00F3ja el\u0151k\u00E9sz\u00EDtve', sound=True, icon='INFO')
...
def _find_cache_version():
    ...
    try:
        curVersion = control.addon('plugin.video.exoshark').getAddonInfo('version')
