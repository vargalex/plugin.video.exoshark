            ...
            if control.setting('bookmarks.trakt') == 'true':
                try:
                    ...
                    if control.setting('bookmarks.auto') == 'false':
                        try:
                            yes = control.dialog.contextmenu([u'Folytat\u00E1s', control.lang(32501).encode('utf-8'), ])
                        except:
                            yes = control.yesnoDialog(u'Folytat\u00E1s', '', '', str(name), control.lang(32503).encode('utf-8'),
